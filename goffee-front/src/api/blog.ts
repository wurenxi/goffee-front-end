...
export const getAllArticleSections = () =>
  request({
    url: '/api/front/blog/section/list',
    method: 'get'
...
export const publishArticle = (data: ArticleRequestVO) =>
  request({
    url: '/api/front/blog/article/save',
    method: 'post',
    data
...
export const getArticleItemInfo = (articleId: string) =>
  request({
    url: `/api/front/blog/article/detailinfo/${articleId}`,
    method: 'get'
...
export const getArticlePage = (data: ArticlePageReqVO) =>
  request({
    url: '/api/front/blog/article/page',
    method: 'post',
    data
...
export const getUserArticlePage = (userId: string, data: ArticlePageReqVO) =>
  request({
    url: `/api/front/blog/article/page/${userId}`,
    method: 'post',
    data
  }) as AxiosPromise<ArticlePageResVO>
...
export const getArticleCount = (userId: string) =>
  request({
    url: '/api/front/blog/article/count',
    method: 'get',
    params: { userId }
...
export const deleteArticleLogical = (articleId: string) =>
  request({
    url: `/api/front/blog/article/logical/delete/${articleId}`,
    method: 'get'
  })
...
export const updateArticle = (data: UpdateArticleFormVO) =>
  request({
    url: '/api/front/blog/article/update',
    method: 'post',
    data
  })
...
export const queryTinymceCodeLanguage = () =>
  request({
    url: '/api/front/blog/language/list',
    method: 'get'
...
export const queryArticleTips = (keyword: string) =>
  request({
    url: '/api/front/blog/article/searchtip',
    method: 'get',
    params: { keyword }
